...
def run(BASE_DIR):
    ...
    df["peso manejado + exportado (t)"] = df["peso total (t)"]  # se puede usar la misma que peso total
    ...
    styler = (
        ...
        .apply(color_gradiente, subset=[
            "peso manejado", "peso neto exportado", "peso total (t)", "peso manejado + exportado (t)"
        ])
        .set_table_styles([
            {"selector": "th",
