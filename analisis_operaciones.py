...
def run(BASE_DIR):
    ...
    fig_export = px.histogram(
        df,
        x="peso neto exportado",
        nbins=30,
        title="Distribución del Peso Neto Exportado"
    )
    ...
    fig_import = px.histogram(
        df,
        x="peso neto importado",
        nbins=30,
        title="Distribución del Peso Neto Importado"
    )
